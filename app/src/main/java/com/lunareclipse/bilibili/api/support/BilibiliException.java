...
public class BilibiliException extends Exception
{
    ...
    public BilibiliException(int paramInt)
    {
        this.mCode = paramInt;
    }

    public BilibiliException(int paramInt, String paramString)
    {
        super(paramString);
        this.mCode = paramInt;
    }

    public BilibiliException(int paramInt, String paramString, Throwable paramThrowable)
    {
        super(paramString, paramThrowable);
        this.mCode = paramInt;
    }

    public BilibiliException(String paramString)
    {
        super(paramString);
    }

    public BilibiliException(Throwable paramThrowable)
    {
